    ...
    >
      <ResponsiveContainer>
        <ComposedChart data={bars}>
          ...
          <YAxis yAxisId="flow" orientation="left" tick={{ fontSize: 10, fill: '#555' }} tickLine={false} axisLine={{ stroke: '#1e1e2e' }} />
          <YAxis yAxisId="ret" orientation="right" tick={{ fontSize: 10, fill: '#555' }} tickLine={false} axisLine={{ stroke: '#1e1e2e' }} tickFormatter={v => `${v.toFixed(1)}%`} />
